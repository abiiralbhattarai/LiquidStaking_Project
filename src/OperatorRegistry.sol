...
contract OperatorRegistry is Ownable {
    ...
    function addValidators(
        Validator[] calldata validatorArray
    ...
    function setWithdrawalCredential(
        bytes memory _new_withdrawal_pubkey
    ) external onlyByOwnGov {
